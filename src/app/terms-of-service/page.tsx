      ...
      <>
        <div className="mx-auto max-w-5xl px-8 sm:mt-10">
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            By using Email Client you confirm your acceptance of, and agree to
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            The Email Client Software License facilitates the acquisition of
            Email Client software through a single purchase, granting users
            unrestricted and perpetual access to its comprehensive
            functionalities. Tailored for independent creators, entrepreneurs,
            and small businesses, Email Client empowers users to create
            compelling web pages and online portfolios. This license entails a
            straightforward and flexible arrangement, exempting users from
            recurring fees or subscriptions. However, it is important to
            ...
            distribution and utilization. Opting for the Email Client Software
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            Due to the nature of digital products, the Email Client boilerplate
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            It is not warranted that Email Client will meet your requirements or
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            Email Client does not give any warranty, guarantee or other term as
            to the quality, fitness for purpose or otherwise of the software.
            Email Client shall not be liable to you by reason of any
            ...
            costs, expenses or other claims (whether caused by Email Client's
            ...
            or services by Email Client. Email Client shall not be liable or
            ...
            that Email Client are deemed liable to you for breach of this
            Agreement, you agree that Email Client's liability is limited to the
            ...
            Email Client from any and all obligations, liabilities and claims in
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            Email Client is not responsible for what the user does with the
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            As we continue to improve Email Client and expand our offerings, the
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            ...
            relationship exists between you and Email Client as a result of your
            use of these services. You agree not to hold yourself out as a
            representative, agent or employee of Email Client. You agree that
            Email Client will not be liable by reason of any representation, act
